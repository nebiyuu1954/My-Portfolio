...
const LandingPage = () => {
  ...
  const message = "I'm a passionate web developer with a knack for creating dynamic and user-friendly websites. With expertise in modern JavaScript frameworks like react with responsive design and backends like django, I strive to build seamless digital experiences that make an impact.";
